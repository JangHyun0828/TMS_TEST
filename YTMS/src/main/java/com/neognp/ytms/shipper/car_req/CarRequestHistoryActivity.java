...
public class CarRequestHistoryActivity extends BasicActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.car_request_history_activity);
        ...
        try {
            ...
            new AsyncTask<Void, Void, Bundle>() {
                ...
                protected Bundle doInBackground(Void... arg0) {
                    ...
                    return YTMSRestRequestor.requestPost(API.URL_SHIPPER_CAR_REQUEST_HISTORY, false, payloadJson, true, false);
                }
    ...
    private class ListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            ...
            if (viewType == TYPE_LIST_ITEM) {
                View v = View.inflate(getContext(), R.layout.car_request_history_item, null);
        ...
        class ListItemView extends CarRequestHistoryActivity.ListAdapter.ItemViewHolder {
            ...
            public void onBindViewData(Bundle item) {
                try {
                    ...
                    // 차량대수
                    ((TextView) itemView.findViewById(R.id.dataTxt2)).setText(item.getString("CAR_CNT", "0"));
                } catch (Exception e) {
                    e.printStackTrace();
                }
            }
