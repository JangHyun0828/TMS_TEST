...
public class PalletsRequestHistoryActivity extends BasicActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.pallets_request_history_activity);
    ...
    private class ListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            ...
            if (viewType == TYPE_LIST_ITEM) {
                View v = View.inflate(getContext(), R.layout.pallets_request_history_item, null);
        ...
        class ListItemView extends PalletsRequestHistoryActivity.ListAdapter.ItemViewHolder {
