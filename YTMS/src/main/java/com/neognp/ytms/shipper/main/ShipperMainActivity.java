package com.neognp.ytms.shipper.main;
...
public class ShipperMainActivity extends BasicActivity {
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            // 접수: 차량요청
            case R.id.menuBtn0:
                startActivity(new Intent(this, CarRequestActivity.class), options.toBundle());
                break;
            // 배차
            case R.id.menuBtn1:
                startActivity(new Intent(this, ShipperCarAllocInfoActivity.class), options.toBundle());
                break;
            // 접수: 팔레트 요청
            case R.id.menuBtn2:
                startActivity(new Intent(this, PalletsRequestActivity.class), options.toBundle());
                break;
            // 공지사항
            case R.id.menuBtn3:
        ...
        try {
            ...
            new AsyncTask<Void, Void, Bundle>() {
                ...
                protected Bundle doInBackground(Void... arg0) {
                    ...
                    return YTMSRestRequestor.requestPost(API.URL_SHIPPER_ALLOC_CNT, false, payloadJson, true, false);
                }
