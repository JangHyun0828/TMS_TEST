...
public class ReceiptDispatchCheckActivity extends BasicActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.receipt_dispatch_activity);
        ...
        setTitleBar("인수증 이미지 발송 확인", R.drawable.selector_button_back, 0, R.drawable.selector_button_refresh);
        ...
        ((TextView) findViewById(R.id.sumTitle)).setText("미발송");
        ...
        try {
            ...
            new AsyncTask<Void, Void, Bundle>() {
                ...
                protected Bundle doInBackground(Void... arg0) {
                    ...
                    return YTMSRestRequestor.requestPost(API.URL_CAR_RECEIPT_DISPATCH_HISTORY, false, payloadJson, true, false);
                }
                ...
                protected void onPostExecute(Bundle response) {
                    ...
                    try {
                        ...
                        if (result_code.equals("200")) {
                            ...
                            sumTxt.setText(TextUtil.formatCurrency(resBody.getInt("tot_cnt")));
                        } else {
    ...
    private class ListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            ...
            if (viewType == TYPE_LIST_ITEM) {
                View v = View.inflate(getContext(), R.layout.receipt_dispatch_item, null);
        ...
        class ListItemView extends ReceiptDispatchCheckActivity.ListAdapter.ItemViewHolder {
            ...
            public void onBindViewData(Bundle item) {
                try {
                    ...
                    ImageButton cameraBtn = itemView.findViewById(R.id.cameraBtn);
                    String RECEIPT_YN = item.getString("RECEIPT_YN", "X");
                    // 미완료: 인수증 촬영 필요
                    ...
                    // 완료: 인수증 사진 불필요
                    else if (RECEIPT_YN.equalsIgnoreCase("X")) {
                        cameraBtn.setVisibility(View.INVISIBLE);
                        cameraBtn.setOnClickListener(null);
                    }
                } catch (Exception e) {
                    e.printStackTrace();
                }
