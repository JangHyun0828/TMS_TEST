...
public class ThirdPartyCarRequestHistoryActivity extends BasicActivity {

    private boolean onReq;

    private Calendar curCal;

    private TextView sumTxt0, sumTxt1;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.thirdparty_car_request_history_activity);
        ...
        sumTxt0 = findViewById(R.id.sumTxt0);
        sumTxt1 = findViewById(R.id.sumTxt1);
        ...
        try {
            ...
            new AsyncTask<Void, Void, Bundle>() {
                ...
                protected Bundle doInBackground(Void... arg0) {
                    ...
                    return YTMSRestRequestor.requestPost(API.URL_THIRDPARTY_CAR_REQUEST_HISTORY, false, payloadJson, true, false);
                }
                ...
                protected void onPostExecute(Bundle response) {
                    ...
                    try {
                        ...
                        if (result_code.equals("200")) {
                            ...
                            addListItems(data);
                            sumTxt0.setText("하차지 합계 :  " + resBody.getInt("list_cnt", 0) + "건");
                            sumTxt1.setText("팔레트 합계 :  " + resBody.getInt("tot_cnt", 0) + "건");
                        } else {
    ...
    private class ListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            ...
            if (viewType == TYPE_LIST_ITEM) {
                View v = View.inflate(getContext(), R.layout.thirdparty_car_request_history_item, null);
        ...
        class ListItemView extends ThirdPartyCarRequestHistoryActivity.ListAdapter.ItemViewHolder {
            ...
            public void onBindViewData(Bundle item) {
                try {
                    // 하차지명
                    ((TextView) itemView.findViewById(R.id.dataTxt0)).setText(item.getString("TO_CENTER_NM", ""));

                    // 팔레트수
                    ((TextView) itemView.findViewById(R.id.dataTxt1)).setText(item.getString("PALLET_CNT", "0"));

                    // 요청자
                    ((TextView) itemView.findViewById(R.id.dataTxt2)).setText(item.getString("INSERT_USER", ""));
                } catch (Exception e) {
                    e.printStackTrace();
                }
            }
