...
public class LoadListActivity extends BasicActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.car_loadlist_activity);
	...
	private synchronized void selectLoad()
	{
		if (onReq)
			return;
		...
		try
		{
			...
			new AsyncTask<Void, Void, Bundle>()
			{
				...
				protected Bundle doInBackground(Void... arg0)
				{
					...
					return RestRequestor.requestPost(API.URL_LOAD_LIST, false, payloadJson, true, false);
				}
	...
	private class ListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>
	{
		...
		public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType)
		{
			...
			{
				View v = View.inflate(getContext(), R.layout.car_load_item, null);
		...
		class ListItemView extends ListAdapter.ItemViewHolder
		{
			...
			public void onBindViewData(Bundle item)
			{
				try
				{
					...
					String START_YN = item.getString("START_YN", "");
					...
					ConstraintLayout layoutList = (ConstraintLayout) itemView.findViewById(R.id.layout_list);
					if(START_YN.equalsIgnoreCase("N"))
					{
						layoutList.setBackgroundResource(R.drawable.border1_grey);
						layoutList.setAlpha(0.5f);
					}
					else
					{
						layoutList.setBackgroundResource(R.drawable.border1_white);
						layoutList.setAlpha(1f);
					}
				}
				catch (Exception e)
				{
