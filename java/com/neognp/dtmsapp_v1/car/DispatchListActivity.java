		...
		class ListItemView extends ListAdapter.ItemViewHolder
		{
			...
			public void onBindViewData(Bundle item)
			{
				try
				{
					...
					String DSP_PALLET_CD = item.getString("DSP_PALLET_CD", "");
					String DSP_PALLET_NM = item.getString("DSP_PALLET_NM", "");
					...
					String FILE_YN = item.getString("FILE_YN", "");
					...
					if(!DSP_PALLET_CD.equals("") || DSP_PALLET_CD != null)
					{
						dataTxt7.setText("(" + DSP_PALLET_CD + ")" + DSP_PALLET_NM);
					}

					TextView dataTxt8 = ((TextView) itemView.findViewById(R.id.dataTxt8));
					dataTxt8.setText(REMARK1);

					TextView dataTxt9 = ((TextView) itemView.findViewById(R.id.dataTxt9));
					dataTxt9.setText(REMARK2);
					...
					btnCall.setOnClickListener(new View.OnClickListener()
					{
						...
						public void onClick(View v)
						{
							ConfirmCancelDialog.show(DispatchListActivity.this, "[" + OUT_NM + "]" + "에 전화 연결하시겠습니까?", "취소", "확인", true, new ConfirmCancelDialog.DialogListener()
							{
					...
					btnLocation.setOnClickListener(new View.OnClickListener()
					{
						public void onClick(View v)
						{
							Intent intent = new Intent(DispatchListActivity.this, LocationActivity.class);
					...
					btnPallet.setOnClickListener(new View.OnClickListener()
					{
						public void onClick(View v)
						{
							...
							Intent intent = new Intent(DispatchListActivity.this, PalletOutActivity.class);
							intent.putExtras((Bundle) item.clone());
					...
					if(!FILE_YN.equalsIgnoreCase("N"))
					{
						btnReceipt.setPressed(true);
					}
					btnReceipt.setOnClickListener(new View.OnClickListener()
					{
						public void onClick(View v)
						{
							...
							Intent intent = new Intent(DispatchListActivity.this, ReceiptCameraActivity.class);
							intent.putExtras((Bundle) item.clone());
							startActivityForResult(intent, 0, options.toBundle());
						}
					});
