...
public class OrderActivity extends BasicActivity {
    ...
    private Button btnDate, btnPrevDate, btnNextDate, btnNewOrder, fromDateBtn, toDateBtn;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.cust_order_activity);
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.btn_new_order:
                ...
                Intent intent = new Intent(OrderActivity.this, OrderNewActivity.class);
                intent.putExtra("PAGE_GB", "INSERT");
                intent.putExtra("CORP_CD", Key.getUserInfo().getString("DEPT_CD"));
                intent.putExtra("CUST_CD", Key.getUserInfo().getString("USER_CD"));
                intent.putExtra("CUST_NM", Key.getUserInfo().getString("PRF_NM"));
                intent.putExtra("ORDER_DT", Key.SDF_CAL_WEEKDAY.format(curCal.getTime()));
                intent.putExtra("DELIVERY_DT", Key.SDF_CAL_WEEKDAY.format(curCal.getTime()));
    ...
    private synchronized void selectOrder()
    {
        if (onReq)
            return;
        ...
        try
        {
            ...
            new AsyncTask<Void, Void, Bundle>()
            {
                ...
                protected Bundle doInBackground(Void... arg0)
                {
                    ...
                    return RestRequestor.requestPost(API.URL_ORDER_LIST, false, payloadJson, true, false);
                }
    ...
    private class ListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>
    {
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType)
        {
            ...
            {
                View v = View.inflate(getContext(), R.layout.cust_order_item, null);
        ...
        class ListItemView extends OrderActivity.ListAdapter.ItemViewHolder
        {
            ...
            public void onBindViewData(Bundle item)
            {
                try
                {
                    ...
                    String ORDER_DT_INFO = item.getString("ORDER_DT_INFO", "");
                    String DELIVERY_DT_INFO = item.getString("DELIVERY_DT_INFO", "");
                    String CUST_NM = item.getString("CUST_NM", "");
                    String OUT_NM = item.getString("OUT_NM", "");
                    String ITEM_CNT = item.getString("ITEM_CNT", "");
                    String ITEM_NM = item.getString("ITEM_NM", "");
                    String ITEM_NM_INFO = item.getString("ITEM_NM_INFO", "");
                    String SEND_YN = item.getString("SEND_YN", "");
                    ...
                    orderLayout.setOnClickListener(new View.OnClickListener()
                    {
                        ...
                        public void onClick(View v)
                        {
                            if(SEND_YN.equals("Y"))
                            {
                                showToast("수정이 불가능한 주문입니다.", false);
                                return;
                            }
                            ...
                            intent.putExtra("PAGE_GB", "UPDATE");
                            intent.putExtra("DEPT_NM", CODE_INFO);
                            intent.putExtra("ORDER_DT", ORDER_DT.substring(0, 4) + "년 " + ORDER_DT.substring(4, 6) + "월 " +ORDER_DT.substring(6, 8) + "일");
                            intent.putExtra("DELIVERY_DT", DELIVERY_DT.substring(0, 4) + "년 " + DELIVERY_DT.substring(4, 6) + "월 " +DELIVERY_DT.substring(6, 8) + "일");
                            startActivityForResult(intent, 100, options.toBundle());
                        }
                    });
                }
