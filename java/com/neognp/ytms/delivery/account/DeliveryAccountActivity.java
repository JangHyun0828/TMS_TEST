package com.neognp.ytms.delivery.account;
...
public class DeliveryAccountActivity extends BasicActivity {

    private boolean onReq;

    public void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.delivery_account_activity);
        ...
        ((TextView) findViewById(R.id.callCenterTxt)).setText(R.string.customer_center);
        ((TextView) findViewById(R.id.callCenterPhoneNoTxt)).setText(R.string.customer_center_phone_no);
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.callCenterBtn:
                AppUtil.runCallApp(getString(R.string.customer_center_phone_no), true);
                break;
        }
    }
