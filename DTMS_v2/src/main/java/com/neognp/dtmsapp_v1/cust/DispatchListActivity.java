...
public class DispatchListActivity extends BasicActivity {
		...
		try
		{
			...
			new AsyncTask<Void, Void, Bundle>()
			{
				...
				protected Bundle doInBackground(Void... arg0)
				{
					...
					return RestRequestor.requestPost(API.URL_CUST_DISPATCH, false, payloadJson, true, false);
				}
	...
	private class ListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>
	{
		...
		public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType)
		{
			...
			{
				View v = View.inflate(getContext(), R.layout.cust_dispatch_item, null);
		...
		class ListItemView extends DispatchListActivity.ListAdapter.ItemViewHolder
		{
			...
			public void onBindViewData(Bundle item)
			{
				try
				{
					...
					String CAR_NO = item.getString("CAR_NO", "");
					...
					itemLayout.setOnClickListener(new View.OnClickListener()
					{
						...
						public void onClick(View v)
						{
							CarInfoDialog.show(DispatchListActivity.this, "", DRIVER_NM, CAR_NO, DRIVER_HP, REMARK1, REMARK2);
						}
					});
					...
					btnCall.setOnClickListener(new View.OnClickListener()
					{
						...
						public void onClick(View v)
						{
							ConfirmCancelDialog.show(DispatchListActivity.this, "치주에게 전화 연결하시겠습니까?", "취소", "확인", true, new ConfirmCancelDialog.DialogListener() {
