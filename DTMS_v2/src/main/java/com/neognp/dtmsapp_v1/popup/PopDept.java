...
public class PopDept extends BasicActivity {
    ...
    private EditText deptNm;

    public void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.popup_dept);

        deptNm = (EditText) findViewById(R.id.edt_dept_nm);
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.btn_cancel:
                args.putString("DEPT_NM", "");
                args.putString("DEPT_CD", "");

                Intent intent = new Intent(PopDept.this, OrderNewActivity.class);
    ...
    private synchronized void selectDept()
    {
        if (onReq)
            return;
            ...
            new AsyncTask<Void, Void, Bundle>()
            {
                ...
                protected Bundle doInBackground(Void... arg0)
                {
                    ...
                    try
                    {
                        ...
                        payloadJson.put("deptNm", deptNm.getText().toString());
                        payloadJson.put("corpCd", Key.getUserInfo().getString("DEPT_CD"));
                    }
                    catch (Exception e)
                    {
                        e.printStackTrace();
                    ...
                    return RestRequestor.requestPost(API.URL_POP_DEPT, false, payloadJson, true, false);
                }
    ...
    private class ListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>
    {
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType)
        {
            ...
            {
                View v = View.inflate(getContext(), R.layout.pop_dept_item, null);
        ...
        class ListItemView extends PopDept.ListAdapter.ItemViewHolder
        {
            ...
            public void onBindViewData(Bundle item)
            {
                try
                {
                    String DEPT_NM = item.getString("DEPT_NM", "");
                    String DEPT_CD = item.getString("DEPT_CD", "");
                    String ADDR = item.getString("ADDR", "");

                    TextView dataTxt0 = ((TextView) itemView.findViewById(R.id.txt_data0));
                    dataTxt0.setText(DEPT_NM);

                    TextView dataTxt1 = ((TextView) itemView.findViewById(R.id.txt_data1));
                    dataTxt1.setText(ADDR);

                    ConstraintLayout deptLayout = (ConstraintLayout) itemView.findViewById(R.id.layout_dept);
                    deptLayout.setOnClickListener(new View.OnClickListener()
                    {
                        @Override
                        public void onClick(View v)
                        {
                            args.putString("DEPT_NM", DEPT_NM);
                            args.putString("DEPT_CD", DEPT_CD);
