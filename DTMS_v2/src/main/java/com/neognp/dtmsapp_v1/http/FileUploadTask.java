package com.neognp.dtmsapp_v1.http;
...
public class FileUploadTask extends AsyncTask<Void, Void, Bundle> {

    String TAG = FileUploadTask.class.getSimpleName();
    ...
    public FileUploadTask(String domain, String urlStr, boolean useSSL, JSONObject payloadJson, String fileParamName, String filePath, FileUploadTaskListener listener, boolean showDebug) {
        this.domain = domain;
        this.urlStr = urlStr;
        this.useSSL = useSSL;
    ...
    public FileUploadTask(String domain, String urlStr, boolean useSSL, JSONObject payloadJson, HashMap<String, String> fileParams, FileUploadTaskListener listener, boolean showDebug) {
        this.domain = domain;
        this.urlStr = urlStr;
        this.useSSL = useSSL;
        this.payloadJson = payloadJson;
